  ...
  return (
    <>
      ...
      <div className="synth-bg min-h-screen">
        <main className="max-w-[760px] mx-auto px-5 pt-24 pb-24 text-center">
          <div className="inline-flex items-center gap-2 mono text-xs px-3 py-1 rounded-full border border-[#2a2a32] text-[#8a8a93] mb-7 bg-[#0c0c10]/60">
            <span className="w-1.5 h-1.5 rounded-full bg-[#5b9dd9] shadow-[0_0_8px_#5b9dd9]" />
            Verified by Ethos
          </div>

          <h1 className="chrome-text text-4xl font-bold tracking-tight leading-[1.1]">
            Jobs, filtered by
            <br />
            on-chain trust.
          </h1>
          <p className="text-[#9aa0ab] text-base mt-5 max-w-[520px] mx-auto leading-relaxed">
          ...
          <div className="mt-10 grid grid-cols-3 gap-px bg-[#2a2a32] border border-[#2a2a32] rounded-xl overflow-hidden max-w-[520px] mx-auto">
            {features.map((f) => (
              <div key={f.title} className="bg-[#0c0c10] p-4">
                <div className="text-white font-medium text-[14px]">{f.title}</div>
          ...
          {/* Live candidate preview, centered under hero */}
          <div className="gloss-panel rounded-2xl p-6 max-w-[380px] mx-auto mt-12 text-left">
            ...
            <div className="mt-5 pt-4 border-t border-[#2a2a32]">
              <a href="/candidates" className="btn neon-secondary text-[13px] py-2 px-4 w-full">
                View candidates
              </a>
            </div>
          </div>
